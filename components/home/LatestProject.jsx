  ...
  return (
    <section className='py-16'>
        <div className='container mx-auto px-4 2xl:px-0'>
            <h2 className={`${poppins.className} title-section`}>Our Latest Project</h2>
            ...
            <div className='grid grid-cols-12 gap-[21px] mt-[29px]'>
              ...
              <div className='col-span-12 lg:col-span-7'>
                {" "}
                <Image src={project2} alt="project 2" className='w-full'/>
              </div>
              <div className='col-span-12 lg:col-span-7'>
                {" "}
                <Image src={project3} alt="project 3" className='w-full'/>
              </div>
              <div className='col-span-12 lg:col-span-5'>
                {" "}
                <Image src={project4} alt="project 4" className='w-full'/>
              </div>
            </div>
        </div>
    </section>
